...
export declare function useDeprecatedSendTransaction({ chainId, request, onError, onMutate, onSettled, onSuccess, }?: UseDeprecatedSendTransactionArgs & UseDeprecatedSendTransactionConfig): {
    ...
    isSuccess: boolean;
    reset: () => void;
    sendTransaction: (args?: DeprecatedSendTransactionArgs) => void;
    sendTransactionAsync: (args?: DeprecatedSendTransactionArgs) => Promise<import("@ethersproject/providers").TransactionResponse>;
